...
1. **Фото при создании:** HandySeller пробует два варианта:
   - **mediaFiles** в payload создания (cards/upload) — как в ЛК WB при ручном создании;
   - **media/save** после создания — с задержкой 2.5 сек (WB создаёт карточку асинхронно).
